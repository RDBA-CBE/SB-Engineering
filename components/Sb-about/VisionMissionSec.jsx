            ...
            <div className="col-lg-4 col-md-4 m-b30">
              <div className="icon-bx-wraper bx-style-1 p-a30 center">
                ...
                <div className="icon-content">
                  ...
                  <p> To gain global recognition as a leading engineering design firm, distinguished by our expertise, innovation and customer-centric approach in building sustainable and iconic structures.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4 m-b30">
              <div className="icon-bx-wraper bx-style-1 p-a30 center">
                ...
                <div className="icon-content">
                  ...
                  <p> To deliver innovative engineering solutions that enhance the built environment, while prioritizing safety, sustainability and functionality. We strive to exceed client expectations through our steadfast commitment to quality, integrity and professionalism. </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-4 m-b30">
              <div className="icon-bx-wraper bx-style-1 p-a30 center">
                ...
                <div className="icon-content">
                  ...
                  <p>Our leadership consists of seasoned professionals with deep knowledge across various engineering domains. Their vision and dedication nurture a culture of excellence, accountability and continuous growth.</p>
                </div>
              </div>
            </div>
          </div>
